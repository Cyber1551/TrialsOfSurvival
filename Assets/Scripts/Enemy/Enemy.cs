    ...
    public class Enemy : MonoBehaviour
    {
        ...
        public void OnTriggerEnter(Collider other)
        {
            ...
            if (other.gameObject.CompareTag("Weapon"))
            {
                ...
                int damage = other.gameObject.GetComponent<Equipment>().equipment.Damage + (int)Mathf.Round(other.gameObject.GetComponentInParent<BaseStats>().GetStat(Stat.Damage));
